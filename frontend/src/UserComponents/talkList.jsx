...
const TalkListWrap = styled.div`
    ...
    * { font-size: 1.6rem; color: #222; }
    ...
    .ProfileImg { width: 7rem; cursor: pointer; border-radius: 50%; border: 3px solid #423b422e; }
                        ...
                        <a onClick={()=>{
                            ...
                            <div className='talkItem' onContextMenu={(e) => {
                                ...
                                <div className='talkProfileImgWrap'>
                                    <img className='ProfileImg' src={post.img==null||post.img==''? "/img/blank_profile.png": "/"+post.img} alt='프로필 사진'></img>
                                </div>
