...
const QuestionForm = styled.div`
    ...
    ul li { padding: 0.6rem; font-size: 1.8rem; color: #888; cursor: pointer; font-weight: bold; }
    .form { background-color: white; margin: 13rem auto 10rem; width: 112rem; border-radius: 20px; padding: 1.5rem 4rem; box-shadow: 5px 5px 5px 5px rgb(210, 210, 210); }
