...
const ChatDetailForm = styled.div`
    ...
    .chat { width: 35rem; border: 2px solid rgb(240, 240, 240); height: 33rem; margin: 3rem auto; overflow-y: scroll; background-color: rgb(248, 250, 252); padding: 2rem; font-size: 1.5rem; font-weight: normal; color: #444; }
...
const ChatDetailPage = () => {
    ...
    // app.jsx에서 설정한 경로에 붙은 idx값(/:idx) 가져오기
    const id = useParams();

    //팝업
    const [modalOn, setModalOn] = useState(false); 
    let [popup, setPopup] = useState();
    // 팝업으로 띄울 room idx 값 저장 
    let [popupId, setId] = useState(null); 
