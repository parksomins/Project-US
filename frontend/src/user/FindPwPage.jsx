...
const Findidpwcss2 = styled.div`
    * { text-decoration:none; box-sizing: border-box; }
    .tofind .red { color: red; font-size: 1.2rem; margin: 0; display: none; }
    .forheigth { margin-bottom: 1rem; height: 6.5rem; }
    ...
    .findtopnav p { font-size: 1.6rem; font-weight: bold; color: #888; line-height: 3rem; word-break : keep-all; }
    .findtopnav h2 { color: #222; font-size: 2.6rem; }
    .phinput input { border: 1px solid lightgray; background-color: #fff; border-radius: 12px;  width: 100%;  height: 4.5rem; color: black; margin-bottom: 1rem; font-size: 1.4rem;  padding-left: 1rem; }
    input:hover { border: 1px solid #14c1c7; }
    .finregi { margin-top: 2rem; }
    .finregi button{ display: flex; padding: 1.2rem 0;  font-size: 1.6rem;  font-weight: bolder; color: white;  width: 100%;  border-radius: 10px; border: none;  background: #14c1c7; margin: 0 auto; justify-content: center; cursor: pointer; }
    .finregi button:disabled { background: #dfdfdf; }
    .tofind p { font-size: 1.5rem; margin-bottom: 0.8rem }
`;
