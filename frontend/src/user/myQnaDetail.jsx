...
const MyQnaDetailWrap = styled.div`
    * { text-decoration:none; }
    ...
    .content2 { border-radius: 10px; font-size: 1.4rem; text-align: left; width: calc(100% - 4rem); margin: 0 auto; border-bottom: 2px solid rgb(215, 215, 215); box-shadow: 3px 3px 3px 4px rgb(240, 240, 240); padding: 2.3rem 3rem; margin-top: 1.5rem; }
    ...
    .content2 .qnaContent td{ width: calc(100% - 10rem); overflow-wrap: anywhere; box-shadow: 3px 3px 3px 3px #ede9e9; padding: 2rem; border-radius: 8px; }
    input[type="button"] { background-color: #14c1c7; border: 1px solid white; color: white; width: 11rem; height: 3.8rem; border-radius: 5px; box-shadow: 2px 2px 2px 2px rgb(210,210,210);  margin-left: 2rem; font-size: 1.3rem; cursor: pointer; }
                            ...
                            <div className="content2">
                                <table>
                                    <tr>
                                        ...
                                        <th>답변여부</th>
                                        <td>{detail.qnaInfo.message === null ?'답변대기':'답변완료'}</td>
                                    </tr>
                                    <tr>
                                        <th>문의유형</th>
